...
const HomePage: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    document.title = "Portfolio Manager - Manage Your Investments";
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground">
              Track positions, monitor performance, and make informed decisions
              with our powerful portfolio management platform.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              investments, with powerful tools to make informed decisions.
            </p>
          </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent rounded-xl flex items-end">
              <div className="p-6 md:p-10 text-white">
                ...
                <Button
                  size="lg"
                  onClick={() => navigate("/register")}
                  className="gap-2 bg-white text-primary hover:bg-white/90 hover:text-primary"
                >
                  Get Started Today
                  <ArrowRight className="h-4 w-4" />
                </Button>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-center md:text-right">
              <p className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} Portfolio Manager. All rights
                reserved.
              </p>
